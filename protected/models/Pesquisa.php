...
class Pesquisa extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array('pesquisa', 'required'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, pesquisa', 'safe', 'on'=>'search'),
        );
    }
    ...
    public function search()
    {
        ...
        $criteria->compare('pesquisa',$this->pesquisa,true);
    ...
    public function getLastPesquisa(){
        return Yii::app()->db->createCommand("select pesquisa from public.pesquisa ORDER BY id DESC limit 5;")->queryAll();
    }
}